...
import { AddBookDto, UpdateBookDto } from "../dtos";
...
export class BookService
{
    ...
    AddBook = (req: Request<any, any, AddBookDto>, res: Response) => {
    ...
    UpdateBook = (req: Request<BookNumberParams, any, UpdateBookDto>, res: Response) => {
